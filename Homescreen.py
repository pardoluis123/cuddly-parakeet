...
if st.session_state.page is None:
    ...
    file_code_dataset=st.file_uploader('Do you have any datasets, with the kind of scripting you need to get done? It will help us provide a better curation experience!')
